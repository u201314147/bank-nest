...
export class AccountsController {
  ...
  open(
    ...
    return this.accountsService.openAccount(openAccount, accountRepository);
  }
  ...
  async lock(
    ...
    const accountDto: LockAccountResponseDto = await this.accountsService.lock(
      accountId,
      accountRepository,
    );
  ...
  async unlock(
    ...
    const accountDto: LockAccountResponseDto = await this.accountsService.unlock(
      accountId,
      accountRepository,
    );
    if (accountDto.id === null) {
